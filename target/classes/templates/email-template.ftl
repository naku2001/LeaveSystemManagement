...
<table align="center" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" class="background">
   ...
   background-image: url('https://www.zanupfzw.co.zw:8053/v1/company-pictures/header.jpg');
    text-align: left;
        top: 50%;
    left: 50%;
    height: 30%;
...
">
                                        <#--                                        <h4 style="margin-left:220px; color:black; font-size: 30px;font-weight: bolder;">-->
                                        <#--                                            Welcome to Zanu Pf </h4>-->
                                        <#--                                        <h6 style="margin-left:220px; color:yellow; font-size: 13px;">Let us help-->
                                        <#--                                            you<span style=" color:white"> Cover your loved ones Funeral.</span></h6>-->
                                    </td>
                                </tr>
                                <tr>
 ...
 border-radius:5px;
  ...
  font-size: 14px; " href="${ link }" target="_blank">Proceed</a>
                                ...
                                <tr align="center" height="200">
                                    <td valign="" class="footer-cell"
                                        style="background-image: url('https://www.zanupfzw.co.zw:8053/v1/company-pictures/sha5.jpg'); min-height:500px">
